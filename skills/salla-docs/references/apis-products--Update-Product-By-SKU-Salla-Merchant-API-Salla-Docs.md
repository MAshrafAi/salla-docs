# Apis Products  Update Product By Sku Salla Merchant Api Salla Docs

## Table of Contents

- [apis-products/Update-Product-By-SKU-Salla-Merchant-API-Salla-Docs](#apis-products-update-product-by-sku-salla-merchant-api-salla-docs)
...
paths:
  /products/sku/{sku}:
    put:
      ...
      deprecated: false
      description: >-
        This endpoint allows you to update specific product details by passing
        the `sku` as a path parameter. 
      ...
      operationId: Update-Product-By-SKU
      tags:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/put_product_request_body'
            example:
              name: T-Shirt Blue
              price: 96.33
              quantity: 4
            ...
            application/json:
              ...
              example:
                ...
                data:
                  ...
                  maximum_quantity_per_order: 100
                  show_in_app: true
                  notify_quantity: '10'
                  hide_quantity: false
                  ...
                  metadata:
                    ...
                    description: >-
                      This Product is one of the amazing things you can buy for
                      yourself
                    url: https://salla.sa/dev-mvxlkrylzfanmuri/t-shirt/p1672908878
                  ...
                  options:
                    - id: 784299854
                      ...
                      from_date_time: '2025-01-14 14:28:03'
                      to_date_time: '2027-10-14 14:28:03'
                      sort: 6
                      advance: true
                      display_type: text
                      visibility: always
                    ...
                    - id: 2022020687
                      ...
                      not_same_day_order: false
                      choose_date_time: true
                      from_date_time: '2024-10-14 14:28:03'
                      to_date_time: '2025-10-14 14:28:03'
                      sort: 6
                      advance: true
                      display_type: text
                      visibility: always
      ...
      security:
        - bearer: []
      x-salla-php-method-name: updateBySKU
      x-salla-php-return-type: ProductDetails
      x-apidog-folder: Default module/Merchant API/APIs/Products
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394174-run
components:
  schemas:
    put_product_request_body:
      type: object
      properties:
        name:
          type: string
          description: >-
            The designated title or label assigned to a particular product. 🌐
            [Support multi-language](https://docs.salla.dev/421122m0)
        price:
          type: number
        ...
        status:
          type: string
          description: >-
            The current condition or state of a product, indicating whether it
            is available for sale, out of stock, hidden, deleted. List of
            Product Statuses can be found
                  ...
                  day:
                    ...
                    x-apidog-enum:
                      - value: sunday
                        name: ''
                        description: >-
                          The first day of the week. commonly the start of the
                          workweek
                      - value: monday
                        name: ''
                      ...
                      - value: tuesday
                        name: ''
                        description: The third day of the week, a regular working day.
                      - value: wednesday
                        name: ''
                        description: The fourth day of the week, often considered midweek.
                      - value: thursday
                        name: ''
                        description: The fifth day of the week, approaching the weekend.
                      - value: friday
                        name: ''
                        description: The sixth day of the week, commonly a weekend day
                      - value: saturday
                        name: ''
                        description: The seventh day of the week, commonly a weekend day.
                    examples:
                      - sunday
                  is_available:
                    type: boolean
                    ...
                    items:
                      ...
                      properties:
                        from:
                          type: string
                          description: >-
                            The starting time of the available booking slot in
                            24-hour format. Required if `booking_details.type =
                            date_time`.
                          examples:
                            - '14:30'
                        to:
                          type: string
                          description: >-
                            The ending time of the available booking slot in
                            24-hour format. Required if `booking_details.type =
                            date_time`.
                          examples:
                            - '17:30'
        ...
        categories:
          type: array
          description: >-
            A list of categories IDs, that will be associate with the product.
            List of Categories ID can be found
        ...
        require_shipping:
          type: boolean
          description: determent if the product require shipping or not.
        maximum_quantity_per_order:
          type: number
          description: Maximum product quantity for each order.
        weight:
          type: number
          description: >-
        ...
        weight_type:
          ...
          x-apidog-enum:
            ...
            - value: g
              name: ''
              description: Weight is Grams.
            - value: lb
              name: ''
              description: Weight is Pounds
            - value: oz
              name: ''
              description: Weight is Ounces.
        sku:
          type: string
          description: >-
            Stock Keeping Unit is a unique alphanumeric code used to identify
            and manage specific products within a company's inventory. The
            Product SKU. List of Product SKU can be found
            [here](https://docs.salla.dev/api-5394168).
        mpn:
          type: string
          description: >-
        ...
        with_tax:
          type: boolean
          description: The option to indicate that the product price includes tax or not.
          default: true
        tax_reason_code:
          type: string
        ...
        hide_quantity:
          type: boolean
          description: The option to hide product quantity.
        show_in_web:
          type: boolean
          description: >-
            The option  change the product's status to `hidden` if set to `true`
            or `sale` if set to `false`
          x-stoplight:
            id: 2o5xgd3y6kksv
        channels:
          type: array
          ...
          items:
            ...
            x-apidog-enum:
              - value: app
                name: ''
                description: Order made on App.
              - value: web
                name: ''
                description: Order made on Web.
        enable_upload_image:
          type: boolean
          description: >-
        ...
        pinned:
          type: boolean
          description: The option to enable pinning product in categories page.
        active_advance:
          type: boolean
          description: Option to activate advance product details.
        subtitle:
          type: string
        ...
        promotion_title:
          type: string
          description: >-
            A label to display in the main image. 🌐 [Support
            multi-language](doc-421122)
        promotion_subtitle:
          type: string
          description: >-
            A sublabel to display in the main image. 🌐 [Support
            multi-language](doc-421122)
        metadata_title:
          type: string
          description: >-
        ...
        metadata_description:
          ...
          description: >-
            ...
            results. 🌐 [Support multi-language](doc-421122)
        metadata_url:
          type: string
          description: >-
        ...
        brand_id:
          type: number
          description: >-
            A unique identifier associated with a specific brand or
            manufacturer. List of Brand IDs can be found
            [here](https://docs.salla.dev/api-5394213).
        tags:
          type: array
          description: >-
            Labels or markers applied to product listings or entries to indicate
            that they have been recently updated, check tags sections for more
            details. List of Product Tags can be found
