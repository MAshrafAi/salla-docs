# Apis Products  Update Product Price By Sku Salla Merchant Api Salla Docs

## Table of Contents

- [apis-products/Update-Product-Price-By-SKU-Salla-Merchant-API-Salla-Docs](#apis-products-update-product-price-by-sku-salla-merchant-api-salla-docs)
...
info:
  ...
  version: 1.0.0
paths:
  /products/sku/{sku}/price:
    post:
      summary: Update Product Price By SKU
      deprecated: false
      description: >-
        This endpoint allows you to update specific product price by passing the
      ...
      operationId: Update-Product-Price-By-SKU
      tags:
          ...
          application/json:
            schema:
              ...
              properties:
                price:
                  type: number
                  description: The new price assigned to the product.
              x-apidog-orders:
                - price
              required:
                - price
                ...
                data:
                  ...
                  options:
                    ...
                    - id: 2022020687
                      ...
                      not_same_day_order: false
                      choose_date_time: true
                      from_date_time: '2025-02-14 14:28:03'
                      to_date_time: '2025-10-14 14:28:03'
                      sort: 0
                      advance: true
                      display_type: text
                      ...
                      translations:
                        ar:
                          option_name: Size
                          description: هذ المنتج ممتاز جدا لك
                      values:
                        - id: 1144986140
                          name: Small
                          price:
            ...
            application/json:
              ...
              example:
                ...
                error:
                  ...
                  message: alert.validation_failed
                  fields:
                    '{field-name}':
      ...
      security:
        - bearer: []
      x-salla-php-method-name: updatePriceBySKU
      x-salla-php-return-type: ProductDetails
      x-apidog-folder: Default module/Merchant API/APIs/Products
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394176-run
components:
  schemas:
