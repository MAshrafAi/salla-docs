# Apis Shipments  Create Shipment Salla Merchant Api Salla Docs

## Table of Contents

- [apis-shipments/Create-Shipment-Salla-Merchant-API-Salla-Docs](#apis-shipments-create-shipment-salla-merchant-api-salla-docs)
    ...
    post:
      ...
      description: >
        ...
        <CardGroup cols={2}>
          ...
          <Card title="Ship Objects" icon="material-two-tone-local_shipping">
        The following variables are deprecated. Update your Body request to use
        the
        ...
        | `ship_to`    | `country_id`        | `ship_to.country`        |

        | `ship_to`    | `city_id`           | `ship_to.city`           |

        | `ship_from`  | `country_id`        | `ship_from.country`      |

        | `ship_from`  | `country_code`      | `ship_from.country`      |

        | `ship_from`  | `city_id`           | `ship_from.city`         |
          </Card>
        </CardGroup>
      ...
      tags:
        - Default module/Merchant API/APIs/Shipments
        - Shipments
      parameters: []
      requestBody:
        content:
                  ...
                  value:
                    ...
                    error:
                      ...
                      fields:
                        ...
                        ship_to.name:
                          - حقل اسم المستلم مطلوب.
                        ship_from.branch_id:
                          - حقل رقم فرع الالتقاط مطلوب.
          headers: {}
      ...
      x-apidog-folder: Default module/Merchant API/APIs/Shipments
          ...
          properties:
            ...
            postal_code:
              ...
              description: >-
                ...
                This field is required only for addresses in Saudi Arabia (KSA).
              examples:
                - '1000'
              nullable: true
            country_id:
          ...
          properties:
            ...
            short_address:
              ...
              description: >-
                ...
                It provides a simplified, precise version of the National
                Address to speed up delivery and reduce input errors.This field
                is required only for addresses in Saudi Arabia (KSA) and `type`
                is `address`.
              nullable: true
            building_number:
              type: string
              description: >-
                An additional National Address identifier used for more precise
                location specification. This field is required only for
                addresses in Saudi Arabia (KSA) and `type` is `address`.
              nullable: true
            additional_number:
              type: number
              description: >-
                An additional National Address identifier used for more precise
                location specification. This field is required only for
                addresses in Saudi Arabia (KSA)
              nullable: true
            postal_code:
              type: string
              description: >-
                The postal or ZIP code for the shipment's origin address. This
                field is required only for addresses in Saudi Arabia (KSA) and
                `type` is `address`.
              nullable: true
            country_id:
              type: string
