# Apis Product Option Values  Create Product Option Value Salla Merchant Api Salla Docs

## Table of Contents

- [apis-product-option-values/Create-Product-Option-Value-Salla-Merchant-API-Salla-Docs](#apis-product-option-values-create-product-option-value-salla-merchant-api-salla-docs)
- [apis-product-option-values/Delete-Product-Option-Value-Salla-Merchant-API-Salla-Docs](#apis-product-option-values-delete-product-option-value-salla-merchant-api-salla-docs)
- [apis-product-option-values/Product-Option-Value-Details-Salla-Merchant-API-Salla-Docs](#apis-product-option-values-product-option-value-details-salla-merchant-api-salla-docs)
...
paths:
  /products/options/{option}:
    post:
      ...
      deprecated: false
      description: >-
        This endpoint allows you to create new values in specific option for a
        ...
        option value will generate new variant for this new value.
      ...
      tags:
        - Default module/Merchant API/APIs/Product Option Values
        - Product Option Values
      parameters:
        - name: option
          in: path
          description: >-
            Unique identification number assigned to the Product Option. List of
            Product Option IDs can be found
            ...
            application/json:
              ...
              example:
                ...
                data:
                  id: 1130246629
                  name: size
                  description: The product is excellent
                  type: radio
                  required: false
      ...
      x-apidog-folder: Default module/Merchant API/APIs/Product Option Values
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394198-run
components:
  schemas:
...
## apis-product-option-values/Delete-Product-Option-Value-Salla-Merchant-API-Salla-Docs
...
paths:
  /products/options/values/{value}:
    delete:
      ...
      deprecated: false
      description: >-
        This endpoint allows you to delete value from a specific option for a
        specific product by passing the `value` as a path parameter. 
      ...
      x-apidog-folder: Default module/Merchant API/APIs/Product Option Values
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394201-run
components:
  schemas:
    delete_success:
      type: object
...
## apis-product-option-values/Product-Option-Value-Details-Salla-Merchant-API-Salla-Docs
...
paths:
  /products/options/values/{value}:
    get:
      summary: Product Option Value Details
      deprecated: false
      description: >-
        This endpoint allows you to return value details in specific option for
        a specific product by passing the `value` as a path parameter. 
      ...
      x-apidog-folder: Default module/Merchant API/APIs/Product Option Values
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394199-run
components:
  schemas:
