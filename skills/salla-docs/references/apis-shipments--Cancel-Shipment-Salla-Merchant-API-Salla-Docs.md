# Apis Shipments  Cancel Shipment Salla Merchant Api Salla Docs

## Table of Contents

- [apis-shipments/Cancel-Shipment-Salla-Merchant-API-Salla-Docs](#apis-shipments-cancel-shipment-salla-merchant-api-salla-docs)
...
paths:
  /shipments/{shipment_id}/cancel:
    post:
      ...
      deprecated: false
      description: >-
        This endpoint allows you to cancel specific Shipment by passing the
      ...
      operationId: post-shipments-cancel-shipment_id
      tags:
      ...
      security:
        - bearer: []
      x-salla-php-method-name: cancel
      x-salla-php-return-type: Shipment
      x-apidog-folder: Default module/Merchant API/APIs/Shipments
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394235-run
components:
  schemas:
