# Shipments  Return Shipments Salla Merchants Apis Salla Docs

## Table of Contents

- [shipments/Return-Shipments-Salla-Merchants-APIs-Salla-Docs](#shipments-return-shipments-salla-merchants-apis-salla-docs)
...
paths:
  /shipments/{shipment_id}/return:
    post:
      summary: Return Shipments
      deprecated: false
      description: >-
        You can return specific Shipment by providing the ID of the shipment you
        want to return.
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5578813-run
components:
  schemas:
    ShipmentResponse:
