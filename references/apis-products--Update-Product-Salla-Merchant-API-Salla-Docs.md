# Apis Products  Update Product Salla Merchant Api Salla Docs

## Table of Contents

- [apis-products/Update-Product-Salla-Merchant-API-Salla-Docs](#apis-products-update-product-salla-merchant-api-salla-docs)
...
paths:
  /products/{product}:
    put:
            ...
            application/json:
              ...
              example:
                ...
                data:
                  ...
                  maximum_quantity_per_order: 500
                  show_in_app: true
                  notify_quantity: '10'
                  hide_quantity: false
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394170-run
components:
  schemas:
