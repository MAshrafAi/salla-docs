# Apis Shipping Routes  Delete Route Salla Merchant Api Salla Docs

## Table of Contents

- [apis-shipping-routes/Delete-Route-Salla-Merchant-API-Salla-Docs](#apis-shipping-routes-delete-route-salla-merchant-api-salla-docs)
- [apis-shipping-routes/Rout-Details-Salla-Merchant-API-Salla-Docs](#apis-shipping-routes-rout-details-salla-merchant-api-salla-docs)
- [apis-shipping-routes/Routs-List-Salla-Merchant-API-Salla-Docs](#apis-shipping-routes-routs-list-salla-merchant-api-salla-docs)
...
paths:
  /shipping/routes/{id}:
    delete:
      ...
      tags:
        - Default module/Merchant API/APIs/Shipping Routes
        - Shipping Routes
      parameters:
        - name: id
          in: path
      ...
      security:
        - bearer: []
      x-apidog-folder: Default module/Merchant API/APIs/Shipping Routes
...
## apis-shipping-routes/Rout-Details-Salla-Merchant-API-Salla-Docs
...
## apis-shipping-routes/Routs-List-Salla-Merchant-API-Salla-Docs
