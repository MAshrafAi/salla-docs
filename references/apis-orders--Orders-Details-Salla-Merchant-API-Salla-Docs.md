# Apis Orders  Orders Details Salla Merchant Api Salla Docs

## Table of Contents

- [apis-orders/Orders-Details-Salla-Merchant-API-Salla-Docs](#apis-orders-orders-details-salla-merchant-api-salla-docs)
...
paths:
  /orders/{order_id}:
    get:
      ...
      deprecated: false
      description: >-
        This endpoint allows you to return the details for a specific order by
        passing the `order_id` as a path parameter. 


        :::tip[Note]

        • You can able to send the `reference_id` as a *query parameter* to get
        order details. Check the [List Orders
        Endpoint](https://docs.salla.dev/api-5394146/?nav=1) for more.

        • If you send the query parameter `format` and set it equal to `light`,
        you will receive the order details without Shipments, Items, Pickup
        Branch, and Customer Groups objects.
      ...
      parameters:
        ...
        - name: format
          in: query
          description: >-
            Use the format query parameter to return Order details without the
            following objects:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/orderDetails_response_body'
              examples:
                '1':
                  summary: Success
                  value:
                    ...
                    data:
                      ...
                      urls:
                        customer: >-
                          http://store.test/ar/hemo.store/order/wRK4mBzAZN081YbbX3dal23kYrbxqP7j
                      ...
                      tags: []
                '2':
                  summary: Example | Full Details - Deprecated
                  value:
                    status: 200
                    success: true
                    data:
                      ...
                      urls:
                        customer: >-
                          https://store_support.test/ar/engTest/order/zAB3exRyLdXv5WpqNyMrGg4p7Ej8ZKlN
                        admin: /orders/order/zAB3exRyLdXv5WpqNyMrGg4p7Ej8ZKlN
                        rating: >-
                          https://store_support.test/ar/engTest/rating/289032373?expires=1672829836&&signature=d977e37aa0a2cd32f8909217b4c289c98cdbcb77695b2aec2a555f528390bd5a
                      date:
                      ...
                      receipt_image: >-
                        https://cdn.salla.sa/jKxK/md4Pv5jeLEX52zWTboKSVr8VmlX5tNbiu9YF00C0.png
                      currency: SAR
                      amounts:
                        sub_total:
                          amount: 60.22
                      ...
                      shipping:
                        ...
                        pickup_address:
                          ...
                          country_code: SA
                          city: Riyadh
                          shipping_address: "7687 طريق الملك فهد الفرعي,الملك فهد,12262, 7687 طريق الملك فهد الفرعي، الملك فهد، الرياض 12262\_3010، السعودية, Riyadh,السعودية"
                        ...
                        shipment:
                          ...
                          label:
                            format: pdf
                            url: >-
                              https://salla-dev.s3.eu-central-1.amazonaws.com/pZQq/shipping-policy/27922-1xMHJgGZHszfEGLd7NM5WVAMM7IBmfcwrR3sMI4j.pdf
                        policy_options: []
                      ...
                      shipments:
                        - id: 649964784
                          ...
                          courier_name: أوتو
                          courier_logo: >-
                            https://salla-dev-portal.s3.eu-central-1.amazonaws.com/uploads/LUZaDEGwzFRDJKO7XVLXtix71Zb8Z2vBt6xwHrwZ.png
                          ...
                          ship_from:
                            ...
                            city: Medina
                            address_line: >-
                              3391 حسين بين عبدلله بين ضميرا,مسجد الدرع,00000,
                              3391 حسين بين عبدلله بين ضميرا, الدرق موثق, مدينة
                              42313 8700, سعودي عربية, Medina,السعودية
                      ...
                      customer:
                        ...
                        avatar: >-
                          https://salla-dev.s3.eu-central-1.amazonaws.com/customer_profiles/pz010MJLCJUi6kCzBChndZ7ZCFDWLmKSp5MYXE1A.png
                        gender: male
                        birthday:
                      ...
                      items:
                        - id: 951850235
                          ...
                          product:
                            ...
                            thumbnail: >-
                              https://salla-dev.s3.eu-central-1.amazonaws.com/pZQq/BVD74rxrvAmpmtUGQeqD9J6oinsl0hfQRoFqO7Lu.jpg
                            ...
                            gtin: ''
                            description: >-
                              فحم طبيعي 100% غير ضار بالصحة داخل عبوة 6 كيلو
                              مناسب للشواء أو التدفئة.
                            favorite: null
                            features:
                              availability_notify:
                                email: true
                        ...
                        - id: 177812420
                          ...
                          product_thumbnail: >-
                            https://salla-dev.s3.eu-central-1.amazonaws.com/EVxp/73683909-f8ec-410d-885b-4f990e0bb422-500x66.808510638298-fakIdXxsEkBv4rbjGCMgIoz6UNNziBIH523hKC1k.png
                          mpn: '1232112321'
                          gtin: '1231231231231'
                          amounts:
                            price_without_tax:
                          ...
                          product:
                            ...
                            thumbnail: >-
                              https://salla-dev.s3.eu-central-1.amazonaws.com/pZQq/AiNlkYjFO0uSwbPmBcaCQKMiIGmUsKAY25gUiiT7.jpg
                            has_special_price: false
                            regular_price:
                              amount: 17.25
                              currency: SAR
                ...
                '3':
                  ...
                  value:
                    ...
                    error:
                      code: 404
                      message: >-
                        The content you are trying to access is no longer
                        available
          headers: {}
        ...
        '404':
          ...
          headers: {}
          x-apidog-name: Object Not Found
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5394147-run
components:
  schemas:
    orderDetails_response_body:
      type: object
      properties:
        status:
          type: integer
    ...
    OrderDetails:
      ...
      properties:
        ...
        checkout_id:
          type: integer
          description: >-
            A unique identifier assigned to a specific checkout session or
            transaction. 
        reference_id:
          type: integer
          description: >-
            Order reference ID, a specific alphanumeric code or identifier
            associated with an order, used for easy and precise reference and
            tracking of that particular order, this reference ID appears to
        ...
        features:
          ...
          properties:
            shippable:
              type: boolean
              description: Whether or not the order can be shipped
            digitalable:
              type: boolean
              description: Whether or not the order can be turned to digital product
            multiple_shipments_supported:
              type: boolean
              description: >-
                Whether or not the order supports being shipped by multiple
                shipping companies
            order_type_price_quote:
              type: boolean
              description: Whether or not the order type has a price quote
        ...
        actions:
          ...
          properties:
            cancellable:
              type: boolean
              description: >-
                Whether or not the order can be cancelled before it starts being
                shipped
            reorderable:
              type: boolean
              description: 'Whether or not the order can be ordered again '
            payable:
              type: boolean
          x-apidog-orders:
            - cancellable
        ...
        source:
          type: string
          description: 'The origin or channel through which an order was placed. '
        source_details:
          type: object
          properties:
            type:
            ...
            device:
              type: string
              description: >-
                he electronic device, such as a computer, smartphone, or tablet,
                through which an order or purchase is initiated or processed.
            user-agent:
              type: string
              description: >-
        ...
        payment_method:
          type: string
          description: >-
            The specific payment option or financial mechanism chosen and used
            by a customer to pay for a product or service as part of an order,
            encompassing various methods.
        currency:
          type: string
          description: >-
            The specific type of currency or monetary unit in which the total
            cost and prices associated with an order are expressed and
            processed, typically based on the preferences and location of the
            customer or the business's operational currency.
        amounts:
          type: object
          properties:
            sub_total:
            ...
            total:
              ...
              properties:
                amount:
                  type: integer
                  description: >-
                    The final monetary sum that is required to be paid for the
                    order, including the prices of all items or services
                    ordered, any applicable taxes, fees, and shipping costs, as
                    well as any discounts or promotional savings that have been
                    applied.
                currency:
                  type: string
                  description: >-
        ...
        show_weight:
          type: boolean
          description: The option to show the weight value.
        can_reorder:
          type: boolean
          description: The option to enable reorder .
        is_pending_payment:
          type: boolean
          description: >-
        ...
        receiver:
          ...
          properties:
            ...
            email:
              type: string
              description: Order Receiver Email Address
            phone:
              type: string
              description: Order Receiver Phone Number
          x-apidog-orders:
            - name
            - email
            - phone
        ...
        customer:
          type: object
          x-apidog-refs:
            01J3WD1E657WKJWE62CQ8JMVM6: &ref_25
              $ref: '#/components/schemas/Customer'
              x-apidog-overrides:
                groups: null
          x-apidog-orders:
            - 01J3WD1E657WKJWE62CQ8JMVM6
          properties:
            id: &ref_2
              type: number
          ...
          properties:
            id:
              ...
              description: >-
                ...
                with a specific bank account used by a store or business for
