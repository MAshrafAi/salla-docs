# Shipments  Cancel Shipments Salla Merchants Apis Salla Docs

## Table of Contents

- [shipments/Cancel-Shipments-Salla-Merchants-APIs-Salla-Docs](#shipments-cancel-shipments-salla-merchants-apis-salla-docs)
...
paths:
  /shipments/{shipment_id}/cancel:
    post:
      ...
      deprecated: false
      description: >-
        You can cancel specific Shipment by providing the ID of the shipment you
        want to cancel.
            ...
            application/json:
              ...
              example:
                ...
                data:
                  ...
                  created_at:
                    date: '2023-01-16 22:48:45.000000'
                    timezone_type: 3
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5578812-run
components:
  schemas:
    ShipmentResponse:
