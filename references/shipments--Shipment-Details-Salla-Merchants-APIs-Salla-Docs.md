# Shipments  Shipment Details Salla Merchants Apis Salla Docs

## Table of Contents

- [shipments/Shipment-Details-Salla-Merchants-APIs-Salla-Docs](#shipments-shipment-details-salla-merchants-apis-salla-docs)
- [shipments/Shipment-Tracking-Salla-Merchants-APIs-Salla-Docs](#shipments-shipment-tracking-salla-merchants-apis-salla-docs)
  ...
  /shipments/{shipment_id}:
    get:
      ...
      description: >-
        ...
        shipment by providing the ID of the shipment you want to get its details
        in the shipment path parameter.
      ...
      operationId: get-shipments-shipment_id
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5578811-run
components:
  schemas:
    ShipmentResponse:
      ...
      description: >-
        ...
        as **object** for use in a RESTful API for querying shipment data.
...
## shipments/Shipment-Tracking-Salla-Merchants-APIs-Salla-Docs
  ...
  /shipments/{shipment_id}/tracking:
    get:
      ...
      description: >-
        ...
        shipment by providing the ID of the shipment the path parameter.
      ...
      x-apidog-folder: Default module/Shipping and Fulfilment API/Shipments
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-5578814-run
components:
  schemas:
        ...
        data:
          ...
          properties:
            ...
            courier_id:
              type: integer
              description: >-
                Shipment Courier ID. Find a complete list of Shipment companies
            ...
            tracking_link:
              type: string
              description: >-
                This field refers to a hyperlink that provides a direct link to
                the tracking page for the shipment
            label:
              type: object
              properties:
                format:
            ...
            status:
              type: string
              description: This field refers to the current status of the shipment
            history:
              type: array
              items:
                type: object
