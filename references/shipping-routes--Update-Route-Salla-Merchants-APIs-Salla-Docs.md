# Shipping Routes  Update Route Salla Merchants Apis Salla Docs

## Table of Contents

- [shipping-routes/Update-Route-Salla-Merchants-APIs-Salla-Docs](#shipping-routes-update-route-salla-merchants-apis-salla-docs)
...
paths:
  /shipping/routes/{id}:
    patch:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/451700/apis/api-19665289-run
components:
  schemas:
